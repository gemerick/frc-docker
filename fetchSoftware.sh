...
wget https://github.com/wpilibsuite/allwpilib/releases/download/v${wpilib}/WPILib_Linux-${wpilib}.tar.gz

#https://wpilib.screenstepslive.com/s/currentCS/m/cpp/l/1035723-3rd-party-libraries
# http://www.ctr-electronics.com/control-system/hro.html#product_tabs_technical_resources
wget https://github.com/CrossTheRoadElec/Phoenix-Releases/releases/download/v${ctrePath}/CTRE_Phoenix_FRC_Linux_${ctreZip}.zip
...
wget https://github.com/REVrobotics/REV-Software-Binaries/releases/download/revlib-${rev}/REVLib-offline-v${rev}.zip
